            ...
            e = n.nmd(e),
                function() {
                    var o, i = "Expected a function",
                        ...
                        $e = "(?:" + Me + "|" + De + ")",
                        Ve = "(?:" + ze + "|" + De + ")",
                        Ge = "(?:['鈥橾(?:d|ll|m|re|s|t|ve))?",
                        Je = "(?:['鈥橾(?:D|LL|M|RE|S|T|VE))?",
                        Ze = "(?:" + Re + "|" + Be + ")" + "?",
                        Ke = "[" + je + "]?",
            ...
            e.exports = i, o.inherits(i, r.EventEmitter), i.prototype.send = function(e, t, n) {
                if (!this.isClosed) {
                    var r = "string" == typeof e,
                        ...
                        c = s ? 1 : 0;
                    s && (t && t.binary ? (u.write("聙", "binary"), i > 1 && u.write(String.fromCharCode(128 + o / 128), c++, "binary"), u.write(String.fromCharCode(127 & o), c++, "binary")) : u.write("\0", "binary")), r ? u.write(e, c, "utf8") : e.copy(u, c, 0), a ? (t && t.binary || u.write("每", c + o, "binary"), this.continuationFrame = !1) : this.continuationFrame = !0;
                    try {
