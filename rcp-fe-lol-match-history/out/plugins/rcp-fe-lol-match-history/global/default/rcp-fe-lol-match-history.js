    ...
    var e = [, e => {
            ...
            e.exports = p.extend(s.DataBindingMixin, s.FixDataBindingMixin, l.default, {
                ...
                _formatChampMasteryIpXpDescription(e) {
                    const t = [];
                    return e.champMastery && t.push(e.champMastery), e.ipDelta && t.push(e.ipDelta + "聽" + this.get("tra.postgame_progress_ip")), e.xpDelta && t.push(e.xpDelta + "聽" + this.get("tra.postgame_progress_xp")), t.length > 0 ? t.join("聽/聽") : null
                },
