    ...
    var e = [, e => {
            ...
            var c = s.Ember.Component.extend({
                ...
                _drawAxes(e, t, a, n, o, l) {
                    ...
                    const i = s.d3.svg.axis().scale(a.y).tickValues(a.y.domain()).tickSize(t.axis.y.tickSize).orient("left").tickFormat((e => o.formatNumber(e, l.tickFixedPoint, l.isPercentage, l.byThousand).replace("-", "鈥?)));
                ...
                _drawStatsLine(e, t, a, n, o, l, r, i) {
                    ...
                    p.append("circle").attr("class", "data-dot").attr("r", a.label.dotSize), p.append("text").attr("class", "data-dot-text shadow").attr("x", a.label.textOffset.x).attr("y", a.label.textOffset.y).text((e => r.formatNumber(e.stat, i.fixedPoints, i.isPercentage).replace("-", "鈥?))), p.append("text").attr("class", "data-dot-text").attr("x", a.label.textOffset.x).attr("y", a.label.textOffset.y).text((e => r.formatNumber(e.stat, i.fixedPoints, i.isPercentage).replace("-", "鈥?)))
                },
